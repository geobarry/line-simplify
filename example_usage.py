...
import apsc
simp_table=apsc.simplificationTable(pts) # create the simplification table 
simplified_line = apsc.simplifiedLine(simp_table,min_pts=10) # simplify to 10 points
simplified_line = apsc.simplifiedLine(simp_table,max_disp=50) # simplify to areal displacement tolerance


# OTHER ALGORITHMS
# Visvalingam & Whyatt (1993)
import visvalingam as v
import numpy as np
